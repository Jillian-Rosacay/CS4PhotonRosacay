...
public class MenuController implements MouseListener, ActionListener{
    ...
    private static ArrayList<File> loadedFiles = new ArrayList();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == load){
            ...
            try{
                if(loadedFiles.contains(selectedFile.getAbsoluteFile())){
                    JOptionPane.showMessageDialog(menu, "File already loaded.", "Invalid file", JOptionPane.ERROR_MESSAGE);
                }
                else{
                    ...
                    reader.close();
                    JOptionPane.showMessageDialog(menu, "Subjects have been added.", "Account loading", JOptionPane.INFORMATION_MESSAGE);
                }
